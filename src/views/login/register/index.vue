<template>
  <div style="padding:0px 20px 30px 30px;">
     ...
     <el-form  :model="form" status-icon  ref="form" class="demo-form" :rules="regisVal">
       <el-form-item prop="username">
           <label class="inputkeren">
             <input type="text" placeholder=" " v-model="form.username" autocomplete="off">
             <span>Username</span>
           </label>            
        </el-form-item>
        <el-form-item required="" prop="email" >
           <label class="inputkeren">
            <input type="email" placeholder=" " v-model="form.email" autocomplete="off">
            <span>Email</span>
          </label>
        </el-form-item>
        <el-form-item  prop="password">
           <label class="inputkeren">
            <input :key="passwordType" :type="passwordType" placeholder=" " v-model="form.password" autocomplete="off"  >
            <span>Password</span>
        ...
        <el-form-item  prop="password2">
           <label class="inputkeren">
            <input :key="passwordType" :type="passwordType" placeholder=" " v-model="form.password2" autocomplete="off"
            >
